...
export default function StickerPlacer({
  ...
  const [memo, setMemoji] = useState<string>("/images/default-memoji.png")
  ...
  const handleMemojiUpload = async (
    ...
    if (file) {
      if (file.type !== "image/png" && file.type !== "image/jpeg") {
        return showNotification(
          "Error: Please upload a valid PNG or JPEG file for the memo."
        )
      }
                ...
                showDialog(
                  <div className="w-full h-full">
                    ...
                    <p className="text-zinc-500 mb-6">
                      ...
                      can preview your Memo. Open it, make a screenshot and
                      cut out to the edges of the Memo. Then upload it here.
                      <br /> <br />
                      The background color of the Memo will be used as the
