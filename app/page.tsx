...
export const metadata: Metadata = {
  ...
  title: "Memo Laptop Sticker Maker - StickerImage",
  description:
    "Make your own Laptop full of Stickers: Create your own Memo Laptop Sticker image and share it with your friends.",
  openGraph: {
